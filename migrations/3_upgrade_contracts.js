const { deployProxy, upgradeProxy, forceImport, admin, validateUpgrade } = require('@openzeppelin/truffle-upgrades');
...
module.exports = async function(deployer) {    
  //await forceImport("0xaA503BCFaA5388dAa6649161581332EdaA5e794f", MetaSaltMarket);
  //const alreadyDeployed = await MetaSaltMarket.deployed();
  await validateUpgrade("0xaA503BCFaA5388dAa6649161581332EdaA5e794f", MetaSaltMarketV2, {unsafeSkipStorageCheck: false});
  // const metasalt = await upgradeProxy("0xaA503BCFaA5388dAa6649161581332EdaA5e794f", MetaSaltMarketV2, {deployer});
  // console.log('metasalt', metasalt);
  // const adminInstance = await admin.getInstance();
  // const adminAddress = await adminInstance.getProxyAdmin(metasalt.address);
